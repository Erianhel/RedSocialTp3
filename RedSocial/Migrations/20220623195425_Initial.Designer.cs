...
namespace RedSocial.Migrations
{
    ...
    [Migration("20220623195425_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RedSocial.Comentario", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedSocial.Post", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedSocial.Reaccion", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedSocial.Tag", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedSocial.TagPost", b =>
                {
            ...
            modelBuilder.Entity("RedSocial.Usuario", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RedSocial.UsuarioAmigo", b =>
                {
            ...
            modelBuilder.Entity("RedSocial.UsuarioAmigo", b =>
                {
                    b.HasOne("RedSocial.Usuario", "user")
                        .WithMany("misAmigos")
                        .HasForeignKey("num_usr")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RedSocial.Usuario", "amigo")
                        .WithMany("amigosMios")
